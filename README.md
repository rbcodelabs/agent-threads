...
![Agent Threads](https://img.shields.io/badge/Obsidian-Plugin-7C3AED) ![Version](https://img.shields.io/badge/version-0.49.0-blue) [![Roadmap](https://img.shields.io/badge/Roadmap-Compass-6366F1)](https://compass.rbcodelabs.com/portal/rbcodelabs/claude-threads/roadmap)
...
- **First-run onboarding** — on a brand-new install, Agent Threads opens the conversation and Agents List panels, adds the [Chief of Staff](https://github.com/rbcodelabs/chief-of-staff) skill source, and starts a **Chief of Staff** thread that runs `cos-setup` to get you set up. If that can't start (offline, no agent harness installed yet), you get the static getting-started guide instead. Run **Set up Chief of Staff** from the command palette any time; it reopens your existing Chief of Staff thread rather than creating a second one. Turn off **Settings → General → Offer Chief of Staff on first run** to always get the static guide.
